...
## <a href="https://www.kneumoin.com/clean-architecture">Blog Post</a>
...
REST API with custom JWT-based authentication system. Core functionality is about creating and managing links (Simple clone of <a href="https://app.getpocket.com/">Pocket</a>).
...
##### Example Input: 
{
	"secret": "XXXXXXXXXXSECRERTXXXXXXXXXXX"
}

##### Example Output: 
```
{
	"url": "http://localhost:8000/api/links/65f967788cea5aa2cd7a46c8",
} 
```

### GET /api/links/:id

Get secret http://localhost:8000/api/links/:id
